<div class="card">
    <div class="card-body scroll_vertical" style="max-height: 325px;">
        <table class="table table-bordered table-hover text-center" id="documentos">
            <thead class="bg-gray-dark">
                <tr>
                    <th>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" onclick="check_documentos(this)"
                                id="check_documentos">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input chk-dct"
                                    value="<?=$documento->id_documento?>" id="documento_<?=$documento->id_documento?>"
                                    name="documento[]">
                        ...
                        <td>
                            <div class="dropdown dropleft">
                                <!-- Imprimir -->
                                <button
                                    onclick="location.href='<?=baseUrl('documentos/descargar_pdf/'.$documento->id_documento)?>';"
                                    type="button" data-toggle="tooltip" data-placement="top" title="Descargar documento"
                                    class="btn btn-danger btn-descargar">
                                    <i class="fas fa-download"></i>
                                </button>

                                <!-- Ver PDF en nueva pestania-->
                                <button onclick="verPdf('<?=$documento->id_documento?>');" type="button"
                                ...
                                <?php
                                if($documento->envio_atv != '1' || $documento->valido_atv == '0'){
                            ?>
                                <button type="button"
                                    class="btn btn-dark nav-opciones dropdown-toggle dropdown-toggle-split"
                                    id="nv-opc_doc" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 d-flex justify-content-center">
                                                ...
                                                if($documento->envio_atv != '1'){
                                                    ...
                                                    echo '<button disabled onclick="enviar_documento('.$documento->id_documento.');" type="button" data-toggle="tooltip" title="Enviar documento" class="btn btn-success btn-enviar btn-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <select class="form-control form-control-sm" onchange="cargar_documentos(this.value)"
                                    name="tipo_reporte" id="tipo_reporte">
                                    <option value="all"
                                        <?php if(isset($tipo_reporte)&&$tipo_reporte == 'all') echo 'selected'?>>
                                        Todos</option>
                                    <option value="diarios"
                                        <?php if(isset($tipo_reporte)&&$tipo_reporte == 'diarios') echo 'selected'?>>
                                        Diario
                                    </option>
                                    <option value="semanal"
                                        <?php if(isset($tipo_reporte)&&$tipo_reporte == 'semanal') echo 'selected'?>>
                                        Ultima semana
                                    </option>
                                    <option value="semana"
                                        <?php if(isset($tipo_reporte)&&$tipo_reporte == 'semana') echo 'selected'?>>Esta
                                        semana
                                    </option>
                                    <option value="mes"
                                        <?php if(isset($tipo_reporte)&&$tipo_reporte == 'mes') echo 'selected'?>>
                                        Este mes</option>
                                    <option value="semana_anterior"
                                        <?php if(isset($tipo_reporte)&&$tipo_reporte == 'semana_anterior') echo 'selected'?>>
                                        Semana
                                        anterior</option>
                                    <option value="mes_anterior"
                                        <?php if(isset($tipo_reporte)&&$tipo_reporte == 'mes_anterior') echo 'selected'?>>
                                        Mes
                                        anterior</option>
                                    <option value="buscar"
                                        <?php if(isset($tipo_reporte)&&$tipo_reporte == 'buscar') echo 'selected'?>>
                                        Busqueda
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input class="form-control form-control-sm" id="fecha_inicio" type="date"
                                    name="fecha_inicio" value="<?php echo $fecha_inicio;?>"
                                    max="<?php echo $fecha_fin;?>" min="<?=$fecha_inicio?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                ...
                                <input class="form-control form-control-sm" id="fecha_fin" type="date" name="fecha_fin"
                                    value="<?=$fecha_fin?>" max="<?=$fecha_fin?>" min="<?=$fecha_inicio?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="input-group">
                                ...
                                <select class="form-control form-control-sm" id="id_tipo_documento"
                                    name="id_tipo_documento" onchange="cargar_documentos('busqueda')">
                                    <option value="all">Todos</option>
                                    <?php foreach($tipos_documentos as $tipo_documento):?>
                                    <option value="<?=$tipo_documento->id_tipo_documento?>"
                                        <?php if($tipo_documento->id_tipo_documento == $id_tipo_documento) echo 'selected'?>>
                        ...
                        <!-- Opciones -->
                        <div class="col-md-1">
                            <button class="btn btn-primary btn-block btn-sm" data-toggle="tooltip" title="Buscar"
                                id="btn_buscar" type="submit" onclick="cargar_documentos('busqueda')">
