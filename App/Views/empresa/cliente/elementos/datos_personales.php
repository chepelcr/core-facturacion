                    ...
                    <div class="col-md-7">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control inp identification_number" onblur="obtener_contribuyente(this.value)" name="identification[number]" type="text" placeholder="Ingrese el número de cédula" value="<?php if (isset($identification)) {
