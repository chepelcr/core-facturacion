/**Estado de una solicitud en la aplcacion */
var estado = false;
        ...
        $.ajax({
            ...
            if (!data.error) {
                ...
                $.each(data, function (key, valor) {
                    $('#frm_cliente').find("#" + key).val(valor);
                });
                ...
                $('#' + factura_activa).find('.identificacion-cliente').val(data.identificacion);
                ...
                if(validacion)
                {
                    mensajeAutomatico('Atencion', 'El cliente se encuentra registrado en la base de datos', 'info');
                }
            }
