...
function agregar_linea_activa(producto, cantidad = 1, precio_final = 0) {
    ...
    //Si la linea es nula, agregar una linea
    if (linea == null) {
...
function aumentar_linea() {
    ...
    $(linea).find(".numero_linea_lbl").text(lineas_activas);
...
function contar_lineas() {
    ...
    $('#' + factura_activa).find('.linea').each(function () {
        ...
        $(this).find(".numero_linea_lbl").text(lineas);
        ...
        }//Fin de la validacion de la linea
